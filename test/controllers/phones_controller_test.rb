...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { hierarchy_location: @phone.hierarchy_location, member_id: @phone.member_id, role: @phone.role } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { hierarchy_location: @phone.hierarchy_location, member_id: @phone.member_id, role: @phone.role } }
